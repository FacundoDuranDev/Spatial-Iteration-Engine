...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("toggle_overlay", True),
        ("add_modulation", True),
        ("remove_modulation", True),
        ("clear_modulations", True),
        ("toggle_projection", True),
        ("set_projection_corners", True),
        ("set_projection_corner", True),
        ("reset_projection", True),
        ("set_projection_mesh_size", True),
        ("set_projection_mesh_points", True),
        ("set_projection_mesh_point", True),
        ("add_projection_region", True),
        ("remove_projection_region", True),
        ("set_projection_active_region", True),
        ("set_projection_region_enabled", True),
        ("rename_projection_region", True),
        ("start_projection_calibration", True),
        ("capture_projection_calibration", True),
        ("cancel_projection_calibration", True),
        ("pong", True),
        ("flubber", False),
        ("", False),
        (None, False),
