...
from ascii_stream_engine.analyzers.base import BaseAnalyzer
...
class TestFaceAnalyzer(unittest.TestCase):
    def test_face_analyzer_detects(self) -> None:
        ...
        from ascii_stream_engine.analyzers.face import FaceHaarAnalyzer
        ...
        with patch(
            "ascii_stream_engine.analyzers.face.cv2.CascadeClassifier",
            new=DummyCascade,
        ):
